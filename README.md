...
```bash
curl -X POST https://gateway.pipeworx.io/v1/tools/check_vat \
  -H 'Content-Type: application/json' \
  -d '{"countryCode":"DE","vatNumber":"811569869"}'
```

No account needed for the first calls. Inspect any tool: `GET https://gateway.pipeworx.io/v1/tools/check_vat`. Find one: `POST https://gateway.pipeworx.io/v1/tools/search_packs` with `{"query":"..."}`.
